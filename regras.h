...
class Regras {
    ...
    public:
    //getters and setters
    tm get_data_inicio(){return data_inicio;}
    tm get_data_fim(){return data_fim;}
    ...
    void set_data_inicio(tm dt_inicio){data_inicio=dt_inicio;}
    void set_data_fim(tm dt_fim){data_fim=dt_fim;}
